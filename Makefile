all: problem001.out problem002.out problem003.out problem004.out problem005.out problem006.out problem007.out problem008.out problem009.out
...
test:
	python -munittest problem001 problem002 fibonacci factors problem003 \
	    ...
	    problem007 problem008 problem009
